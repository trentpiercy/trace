...
class CoinMarketStatsState extends State<CoinMarketStats> {
  ...
  void _getHL() {
    ...
    for (var i in historyOHLCVTimeAggregated) {
    ...
    var start = historyOHLCVTimeAggregated[0]["close"] == 0 ? 1 : historyOHLCVTimeAggregated[0]["close"];
    var end = historyOHLCVTimeAggregated.last["close"];
    ...
    return new Scaffold(
      appBar: new PreferredSize(
        ...
        child: new AppBar(
          ...
          title: new Text(exchangeData["FROMSYMBOL"] + " " + exchangeData["MARKET"]),
        ),
      ),
                ...
                children: <Widget>[
                  new Column(
                    ...
                    children: <Widget>[
                      ...
                      new Text("\$"+ (exchangeData["PRICE"]).toString(), style: Theme.of(context).textTheme.button.apply(fontSizeFactor: 1.4, color: Theme.of(context).accentColor)),
                    ],
                  ),
                  new Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
