...
class _OHLCVPainter extends CustomPainter {
  ...
  _OHLCVPainter(this.data, {@required this.lineWidth});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < data.length; i++) {
      ...
      if (data[i]["open"] > data[i]["close"]) {
        ...
        rectPaint = new Paint() ..color=Colors.red ..strokeWidth=lineWidth;
        ...
        rectPaint = new Paint() ..color=Colors.green ..strokeWidth=lineWidth;
